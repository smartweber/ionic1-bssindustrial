(function() {
	...
	ContactUsController.$inject = ['$scope', '$state', 'motion', 'EmailConsts', '$ionicPopup', '$ionicViewService'];


	function ContactUsController($scope, $state, motion, EmailConsts, $ionicPopup, $ionicViewService) {
